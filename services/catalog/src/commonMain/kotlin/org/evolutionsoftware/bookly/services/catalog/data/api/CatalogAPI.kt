...
import org.evolutionsoftware.bookly.services.catalog.data.repository.requireSuccess

class CatalogAPI(
    private val httpClient: HttpClient,
) {
    suspend fun getBooks(limit: Int = 100): BooksPaginatedResponseDto =
        httpClient
            .get(BOOKS_PATH) { parameter("limit", limit) }
            .requireSuccess()
            .body()

    suspend fun getBookDetails(bookId: String, languageId: Int): List<BookDetailDto>? {
